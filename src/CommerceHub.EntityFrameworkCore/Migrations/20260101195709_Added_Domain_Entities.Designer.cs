...
namespace CommerceHub.Migrations
{
    ...
    [Migration("20260101195709_Added_Domain_Entities")]
    partial class Added_Domain_Entities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommerceHub.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CommerceHub.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CommerceHub.Entities.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CommerceHub.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CommerceHub.Entities.OrderItem", b =>
                {
                    b.HasOne("CommerceHub.Entities.Order", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("CommerceHub.Entities.Product", b =>
                {
                    b.HasOne("CommerceHub.Entities.Category", null)
                        .WithMany()
